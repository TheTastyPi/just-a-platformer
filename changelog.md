...
Editor
- Fixed a bug where interacting with a stateful block (one-use Switches, Coins, Unstable Blocks, Chain Blocks, etc.) that is generated by Lua causes the game to crash.